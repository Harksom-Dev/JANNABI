...
public class Done implements Screen {
    ...
    public Done(Jannabi game){
        ...
        GameDoneWallpaper = new Texture("Done/01.png");
        ...
        music = Jannabi.manager.get("Audio/Music/GameClear.mp3",Music.class);
    ...
    public void render(float delta) {
        ...
        game.batch.draw(GameDoneWallpaper,0,0);
